...
typedef enum {
  NV_MMU_APERTURE_INVALID = 0x1,
  NV_MMU_APERTURE_VID_MEM = 0x0,
...
#define NV_PFB_PRI_MMU_INVALIDATE_PAGE_ALL 0x00000001U
#define NV_PFB_PRI_MMU_INVALIDATE_HUB_ONLY 0x00000004U
#define NV_PFB_PRI_MMU_INVALIDATE_ALL_PDB  0x00000002U
