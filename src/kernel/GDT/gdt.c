...
void gdt_init(void) {
  ...
  gdt_set_entry(2, 0, 0xFFFFF, GDT_ACCESS_DATA_WRITABLE | GDT_ACCESS_RING0, GDT_FLAG_32BIT | GDT_FLAG_GRANULARITY);
  gdt_set_entry(3, 0, 0xFFFFF, GDT_ACCESS_DATA_WRITABLE | GDT_ACCESS_RING3, GDT_FLAG_32BIT | GDT_FLAG_GRANULARITY);
